...
exports.propPanel = {
    schema: (propPanelProps) => {
        ...
        const parentSchema = typeof propPanel_js_1.propPanel.schema === 'function' ? propPanel_js_1.propPanel.schema(propPanelProps) : {};
        return {
            ...parentSchema,
    ...
    widgets: { ...(propPanel_js_1.propPanel.widgets || {}), mapDynamicVariables },
    defaultSchema: {
        ...propPanel_js_1.propPanel.defaultSchema,
        readOnly: false,
