...
const propPanel_js_1 = require("../text/propPanel.js");
...
const schema = {
    ui: async (arg) => {
        ...
        await index_js_1.default.ui(Object.assign(arg, { mode: 'viewer' }));
    ...
    pdf: index_js_1.default.pdf,
    propPanel: {
        ...index_js_1.default.propPanel,
        widgets: { ...propPanel_js_1.propPanel.widgets, addOptions },
        schema: (propPanelProps) => {
            if (typeof propPanel_js_1.propPanel.schema !== 'function') {
                throw Error('Oops, is text schema no longer a function?');
            }
            // Safely call the parent schema function with proper type checking
            const parentSchema = propPanel_js_1.propPanel.schema(propPanelProps);
        ...
        defaultSchema: {
            ...index_js_1.default.propPanel.defaultSchema,
            type: 'select',
            content: 'option1',
