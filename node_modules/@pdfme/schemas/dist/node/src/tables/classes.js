...
async function calculateWidths(arg) {
    ...
    const getFontKitFontByFontName = (fontName) => (0, helper_js_1.getFontKitFont)(fontName, font, _cache);
...
function getStringWidth(cell, fontKitFont) {
    ...
    const widestLineWidth = textArr
        .map((text) => (0, helper_js_1.widthOfTextAtSize)(text, fontKitFont, fontSize, characterSpacing))
